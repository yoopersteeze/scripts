...
#
# DESCRIPTION
# This script can be used to unmanaged iOS devices from a list of CSV
# seperated by comma.
# Example:
# 63,
# 64,
...
do
  ...
  curl -ksu "$username":"$password" -H "content-type: application/xml" "$server"/JSSResource/mobiledevicecommands/command/UnmanageDevice/id/$id -X POST
done
