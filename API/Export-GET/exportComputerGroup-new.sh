...
curl -ksu $username:$password -H "accept: text/xml" $server/JSSResource/computergroups/id/$id | xmllint --xpath '/computer_group/criteria/criterion' - | xmllint --format - > /Users/"$loggedInUser"/Desktop/Computer-Group-$id.xml
echo "Done!"
